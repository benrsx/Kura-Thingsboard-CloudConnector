package fr.edf.rd.kura.cloudconnection.thingsboard.factory;
...
public class ThingsboardCloudConnectionFactory implements CloudConnectionFactory {

    private static final String FACTORY_PID = "fr.edf.rd.kura.cloudconnection.thingsboard.factory.ThingsboardCloudConnectionFactory";

    // The following constants must match the factory component definitions
    private static final String CLOUD_ENDPOINT_FACTORY_PID = "fr.edf.rd.kura.cloudconnection.thingsboard.cloud.ThingsboardCloudEndpoint";
    ...
    private static final String CLOUD_SERVICE_PID = "fr.edf.rd.kura.cloudconnection.thingsboard.CloudEndpoint";
    private static final String DATA_SERVICE_PID = "fr.edf.rd.kura.cloudconnection.thingsboard.DataService";
    private static final String DATA_TRANSPORT_SERVICE_PID = "fr.edf.rd.kura.cloudconnection.thingsboard.MqttDataTransport";
    ...
    private static final Pattern MANAGED_CLOUD_SERVICE_PID_PATTERN = Pattern
            .compile("^fr\\.edf\\.rd\\.kura\\.cloudconnection\\.thingsboard\\.CloudEndpoint(-[a-zA-Z0-9]+)?$");
    ...
    public Set<String> getManagedCloudConnectionPids() throws KuraException {
        ...
        final BundleContext context = FrameworkUtil.getBundle(ThingsboardCloudConnectionFactory.class)
                .getBundleContext();
